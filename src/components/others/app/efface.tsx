...
export default function Efface({
  toggleSidebar,
  open,
  logoboth,
  Menus,
                ...
                {Menu.subMenu && subMenuOpen && open && (
                  ...
                  >
                    {Menu.subMenu.map((subMenuItem, idx) => (
                      <li
                        key={idx}
                        className="flex px-11 cursor-pointer text-center text-sm text-gray-200 py-1 transition-all [transition-duration:2000ms] ease-out hover:text-gray-300"
                      >
                        {subMenuItem.title}
                      </li>
                    ))}
