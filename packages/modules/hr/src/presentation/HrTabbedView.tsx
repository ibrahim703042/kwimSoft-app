/**
 * HrTabbedView â€” Digital HR-style tabbed content
 *
...
// â”€â”€â”€ Tab config: key, label, icon, component â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const HR_TABS: {
  key: string;
  label: string;
  icon: LucideIcon;
...
export default function HrTabbedView() {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Horizontal tabs â€” Digital HR style */}
