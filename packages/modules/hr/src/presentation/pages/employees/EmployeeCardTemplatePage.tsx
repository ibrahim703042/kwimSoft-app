/**
 * Employee Card Template â€” Create ID card templates with QR/Barcode, biometric/WiFi tracking
 *
...
const EXTRA_FIELD_OPTIONS = [
  { value: "", label: "â€”" },
  { value: "employeeCode", label: "Code employÃ©" },
  { value: "department", label: "DÃ©partement" },
  { value: "email", label: "Email" },
  { value: "phone", label: "TÃ©lÃ©phone" },
  { value: "biometricId", label: "ID biomÃ©trique" },
...
const schema = z.object({
  templateName: z.string().min(1, "Le nom du modÃ¨le est requis"),
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-lg font-semibold">ModÃ¨les de carte employÃ©</h2>
          <p className="text-sm text-muted-foreground">
            CrÃ©ez des modÃ¨les de cartes avec QR, code-barres ou suivi WiFi / biomÃ©trique
          </p>
        </div>
        <Button
          className="bg-[#0F123F]"
      ...
      <div className="grid gap-4">
        {templates.length === 0 ? (
          <div className="border rounded-lg p-8 text-center text-muted-foreground">
            Aucun modÃ¨le. Cliquez sur &quot;Add&quot; pour crÃ©er un modÃ¨le de carte.
          </div>
        ) : (
          templates.map((t) => (
            <div
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {t.orientation === "portrait" ? "Portrait" : "Paysage"} â€¢{" "}
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              {editing ? "Modifier le modÃ¨le" : "Create ID Card Template"}
            </DialogTitle>
          </DialogHeader>
          <form
          ...
          >
            ...
            <div>
              ...
              <Input
                placeholder="ex: Carte employÃ© standard 2025"
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mb-2">
                Toujours affichÃ©s : Photo â€¢ Nom complet â€¢ Poste
              </p>
              <Label className="text-xs">Champs supplÃ©mentaires (ordre souhaitÃ©)</Label>
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Encode l'identifiant employÃ© (biomÃ©trique, WiFi MAC ou ID appareil si renseignÃ©s)
              </p>
            </div>
            ...
            <div className="border-t pt-4">
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <Textarea
                    placeholder="Politique entreprise, contacts d'urgence, instructions pour le journal des prÃ©sences (attendance log)..."
                    {...form.register("backContent")}
                    rows={3}
                    className="mt-1"
                  />
                  <p className="text-xs text-muted-foreground mt-1">
                    IdÃ©al pour rappeler comment pointer (QR, WiFi, biomÃ©trique) et consulter l'attendance log.
                  </p>
                </div>
                <div>
                ...
                <div>
                  <Label>Signature autorisÃ©e (optionnel)</Label>
                  <Input type="file" accept="image/*" className="mt-1" />
                </div>
              </div>
            </div>
