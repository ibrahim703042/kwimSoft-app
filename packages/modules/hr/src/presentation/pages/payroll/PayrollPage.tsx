...
import { payrollApi, employeeApi } from "../../../application/hr.api";
...
export default function PayrollPage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      Swal.fire("Succ̬s!", `La fiche de paie a ̩t̩ ${editing ? "modifi̩e" : "cr̩̩e"}.`, "success");
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      Swal.fire("Supprim̩!", "Fiche de paie supprim̩e.", "success");
      qc.invalidateQueries({ queryKey: ["payrolls"] });
    },
  ...
  const columns = [
    ...
    { accessorKey: "period", header: "P̩riode" },
    {
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            G̩rer les fiches de paie des employ̩s
          </p>
        </div>
        <Button
