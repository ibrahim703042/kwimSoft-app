    ...
    <div className="space-y-6">
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="max-w-xs">
            <FormLabel>Cong̩s allou̩s (jours)</FormLabel>
            <FormControl>
              <Input
                type="number"
                min={0}
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <FormLabel>Cong̩s assign̩s</FormLabel>
        ...
        <div className="rounded-md border">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead>Type de cong̩</TableHead>
              ...
              {assignedLeaves.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={4} className="text-center text-muted-foreground text-sm py-6">
                    Aucun cong̩ assign̩. Cliquez sur Ajouter.
                  </TableCell>
                </TableRow>
              ) : (
