...
import { companyApi } from "../../../application/hr.api";
...
export default function CompanyPage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      Swal.fire(
        "Succ̬s!",
        `L'entreprise a ̩t̩ ${editing ? "modifi̩e" : "cr̩̩e"} avec succ̬s.`,
        "success"
      );
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      Swal.fire("Supprim̩!", "Entreprise supprim̩e.", "success");
      qc.invalidateQueries({ queryKey: ["companies"] });
    },
  ...
  const columns = [
    ...
    { accessorKey: "phone", header: "T̩l̩phone" },
    {
      accessorKey: "status",
      header: "Statut",
      cell: ({ row }: any) => (
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            G̩rer les informations des entreprises
          </p>
        </div>
