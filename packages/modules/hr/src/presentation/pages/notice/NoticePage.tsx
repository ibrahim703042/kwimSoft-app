...
import { noticeApi } from "../../../application/hr.api";
...
const noticeTypes = [
  ...
  { value: "policy_update", label: "Mise Ã  jour politique" },
  { value: "event", label: "Ã‰vÃ©nement" },
  { value: "holiday", label: "Jour fÃ©riÃ©" },
  { value: "urgent", label: "Urgent" },
  { value: "general", label: "GÃ©nÃ©ral" },
  { value: "maintenance", label: "Maintenance" },
  { value: "hr_update", label: "Mise Ã  jour RH" },
];
...
export default function NoticePage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      Swal.fire(
        "SuccÃ¨s!",
        `L'annonce a Ã©tÃ© ${editing ? "modifiÃ©e" : "crÃ©Ã©e"} avec succÃ¨s.`,
        "success"
      );
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      Swal.fire("SupprimÃ©!", "Annonce supprimÃ©e.", "success");
      qc.invalidateQueries({ queryKey: ["notices"] });
    },
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            GÃ©rer les annonces et communications internes
          </p>
        </div>
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="flex gap-6">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <Label htmlFor="isForAllEmployees">Pour tous les employÃ©s</Label>
                  </div>
                  <div className="flex items-center gap-2">
                    <Checkbox
                      id="isPinned"
                    ...
                    />
                    <Label htmlFor="isPinned">Ã‰pingler</Label>
                  </div>
                  <div className="flex items-center gap-2">
                    <Checkbox
                    ...
                    />
                    <Label htmlFor="requiresAcknowledgment">AccusÃ© de rÃ©ception</Label>
                  </div>
                </div>
              </div>
