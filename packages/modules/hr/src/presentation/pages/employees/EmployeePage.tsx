/**
 * EmployeePage â€” List with CrudPage; create/edit in CrudForm + TabbedForm.
...
import { employeeApi, departmentApi, positionApi } from "../../../application/hr.api";
...
export default function EmployeePage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      Swal.fire("SuccÃ¨s!", `EmployÃ© ${editing ? "modifiÃ©" : "crÃ©Ã©"} avec succÃ¨s.`, "success");
    ...
    <>
      <CrudPage
        config={{
          ...
          searchPlaceholder: "Rechercher les employÃ©s...",
      ...
      <CrudForm
        ...
        title={editing ? "Modifier l'employÃ©" : "Nouvel employÃ©"}
        form={form}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex items-center gap-2 space-y-0">
                ...
                <Label className="font-normal text-sm cursor-pointer">DÃ©tail entreprise</Label>
              </FormItem>
            )}
          />
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex items-center gap-2 space-y-0">
                ...
                <Label className="font-normal text-sm cursor-pointer">CongÃ©s</Label>
              </FormItem>
            )}
          />
          <FormField
