...
export default function SettingsPage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      Swal.fire("Succ̬s!", "Param̬tres enregistr̩s avec succ̬s.", "success");
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Configurer les param̬tres du syst̬me RH
          </p>
        </div>
        <Button
      ...
      <form onSubmit={formik.handleSubmit} className="space-y-6">
        <div className="rounded-lg border bg-card p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-muted-foreground">
              D̩finir les jours et heures de travail par d̩faut
            </p>
          </div>
        ...
        <div className="rounded-lg border bg-card p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-muted-foreground">
              Configurer les param̬tres de cong̩s par d̩faut
            </p>
          </div>
          <div className="space-y-4">
            <div className="grid grid-cols-4 gap-4">
              <div>
                <Label>Cong̩s annuels (jours)</Label>
                <Input
              ...
              <div>
                <Label>Cong̩s maladie (jours)</Label>
                <Input
        ...
        <div className="rounded-lg border bg-card p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-muted-foreground">
              Configurer les param̬tres de paie
            </p>
          </div>
          <div className="space-y-4">
            <div className="grid grid-cols-4 gap-4">
        ...
        <div className="rounded-lg border bg-card p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-muted-foreground">
              Configurer les param̬tres de pr̩sence
            </p>
          </div>
          <div className="space-y-4">
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                <Label>Seuil d̩part anticip̩ (min)</Label>
                <Input
        ...
        <div className="rounded-lg border bg-card p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-muted-foreground">
              Configurer les pr̩f̩rences de notification
            </p>
          </div>
          <div>
