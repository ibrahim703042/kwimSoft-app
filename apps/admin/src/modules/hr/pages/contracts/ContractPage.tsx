...
import { contractApi, employeeApi } from "@kwim/modules-hr";
...
export default function ContractPage() {
  ...
  const columns = [
    ...
    },
    {
      id: "startDate",
      label: "Début",
      render: (r: ContractItem) => (r.startDate ? new Date(r.startDate).toLocaleDateString() : "—"),
    },
    {
      id: "endDate",
      label: "Fin",
      render: (r: ContractItem) => (r.endDate ? new Date(r.endDate).toLocaleDateString() : "—"),
    },
    {
      id: "salary",
      label: "Salaire",
          ...
          {viewing && (
            <div className="grid grid-cols-2 gap-3 text-sm py-2">
              ...
              <div className="col-span-2">
                <span className="font-medium text-muted-foreground">Notes:</span> {viewing.notes || "—"}
              </div>
            </div>
          )}
        </DialogContent>
