...
const createGroup = async (values: GroupFormValues, idGroup: string) => {
...
export default function Groupe() {
    ...
    const mutation = useMutation({
        mutationFn: (values: GroupFormValues) => createGroup(values, idGroup || ""),
        onSuccess: () => {
            Swal.fire({
                title: "Succès!",
                            ...
                            <DialogContent className="sm:max-w-md">
                                ...
                                <form onSubmit={formik.handleSubmit} className="space-y-4">
                                    ...
                                    <div className="flex sm:justify-end">
                                        <Button type="submit" disabled={mutation.isPending} size="sm" className="bg-[#0F123F] py-2 text-sm px-4 text-white">
                                            Enregistrer
                                        </Button>
                                    </div>
                                </form>
