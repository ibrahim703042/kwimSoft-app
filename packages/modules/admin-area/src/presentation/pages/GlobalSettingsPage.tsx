...
import { APP_CONFIG, FEATURES } from "@kwim/config";
...
} from "../../domain/lib/featureFlags";
import { appendAuditEvent } from "../../domain/lib/auditLog";
...
export default function GlobalSettingsPage() {
  ...
  const defaultKeys = Object.keys(FEATURES);
