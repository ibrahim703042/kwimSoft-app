...
const STATUS_OPTIONS = [
  ...
  { value: "on_leave", label: "En cong̩" },
  { value: "probation", label: "P̩riode d'essai" },
...
export function JobTab({ form, departments, positions, employees }: JobTabProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h4 className="text-sm font-medium text-muted-foreground mb-3">D̩tail entreprise</h4>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="S̩lectionner agence" {...field} value={field.value ?? ""} />
                </FormControl>
              </FormItem>
            )}
          />
            ...
            render={({ field }) => (
              <FormItem className="flex flex-row items-center gap-2 space-y-0 pt-8">
                ...
                <FormLabel className="font-normal">
                  Pr̩sence pendant jours f̩ri̩s et cong̩s bureau
                </FormLabel>
              </FormItem>
            )}
          />
