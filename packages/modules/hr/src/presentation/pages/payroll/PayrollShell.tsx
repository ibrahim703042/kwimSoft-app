...
const items: ShellNavItem[] = [
  ...
  { key: "setting", label: "Param̬tres paie", icon: Settings, path: "setting" },
  { key: "advance-salary", label: "Avances sur salaire", icon: Banknote, path: "advance-salary" },
  { key: "employee-salary", label: "Salaires employ̩s", icon: UserCircle, path: "employee-salary" },
  { key: "tax-report", label: "Rapport fiscal", icon: FileBarChart, path: "tax-report" },
  { key: "tasks", label: "T̢ches paie", icon: CheckSquare, path: "tasks" },
