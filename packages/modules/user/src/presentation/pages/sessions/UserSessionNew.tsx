...
import { Button } from "@kwim/shared-ui/ui";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import Swal from "sweetalert2";
import { userSessionApi } from "../../../application/user.api";
...
export default function UserSessionNew() {
    ...
    let sessionContent;
    if (loadingSessions) {
        sessionContent = <div className="text-center py-4">Chargement...</div>;
    } else if (sessions.length === 0) {
        sessionContent = <div className="text-center py-8 text-gray-500">Aucune session active</div>;
    } else {
        sessionContent = <EnhancedTable columns={columns} data={sessions} />;
    }
