...
import { branchApi, companyApi } from "../../../application/hr.api";
...
const branchTypes = [
  { value: "headquarters", label: "SiÃ¨ge social" },
  { value: "regional_office", label: "Bureau rÃ©gional" },
  { value: "operational", label: "OpÃ©rationnel" },
];
...
export default function BranchPage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      Swal.fire(
        "SuccÃ¨s!",
        `La succursale a Ã©tÃ© ${editing ? "modifiÃ©e" : "crÃ©Ã©e"} avec succÃ¨s.`,
        "success"
      );
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      Swal.fire("SupprimÃ©!", "Succursale supprimÃ©e.", "success");
      qc.invalidateQueries({ queryKey: ["branches"] });
    },
  ...
  const columns = [
    ...
    { accessorKey: "code", header: "Code" },
    {
      accessorKey: "company",
      header: "Entreprise",
      cell: ({ row }: any) => row.original.company?.name || "â€”",
    },
    {
      accessorKey: "type",
      header: "Type",
    ...
    },
    {
      ...
      cell: ({ row }: any) => {
        ...
        return addr ? `${addr.city || ""}, ${addr.country || ""}`.trim() : "â€”";
      },
    },
    {
      accessorKey: "status",
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            GÃ©rer les succursales et bureaux
          </p>
        </div>
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <Label htmlFor="isHeadquarters">SiÃ¨ge social</Label>
                </div>
