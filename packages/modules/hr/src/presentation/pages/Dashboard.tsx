    ...
    >
      ...
      {href && (
        <div className="mt-3 pt-3 border-t border-border/30 flex items-center text-xs text-muted-foreground hover:text-foreground">
          Voir d̩tails <ArrowRight size={12} className="ml-1" />
        </div>
      )}
    </div>
  );
...
const stats = [
  { label: "Employ̩s", icon: Users, color: "#0F123F", href: "/employees" },
  { label: "D̩partements", icon: Building2, color: "#3b82f6", href: "/organization" },
  ...
  { label: "Cong̩s en attente", icon: CalendarOff, color: "#f59e0b", href: "/attendance?tab=leave" },
  { label: "Pr̩sences aujourd'hui", icon: Clock, color: "#10b981", href: "/attendance" },
  ...
  { label: "Formations planifi̩es", icon: GraduationCap, color: "#6366f1", href: "/training" },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-card rounded-xl border border-border/40 p-6 shadow-sm">
          <h3 className="text-sm font-semibold mb-4">Activit̩ r̩cente</h3>
